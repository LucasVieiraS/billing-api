...
public class ClienteRepositoryImpl implements ClienteRepositoryQuery {
  ...
  public Page<Cliente> filter(ClienteFilter clienteFilter, Pageable pageable) {
    ...
    Predicate[] predicates = createRestrictions(clienteFilter, builder, root);
  ...
  private Predicate[] createRestrictions(ClienteFilter clienteFilter, CriteriaBuilder builder, Root<Cliente> root) {
